...
import { message, Button, Space, Input, Checkbox, Drawer } from 'antd';
...
export default (): React.ReactNode => {
  ...
  const [drawerVisible, setDrawerVisible] = useState<any>(false); // 鼠标Connector
  ...
  return (
    <PageContainer pageHeaderRender={false} className={styles.homePage}>
      ...
      <div className={styles.checkbox}>
        <ul>
          <li>
            <Checkbox>道路</Checkbox>
          </li>
          <li>
            <Checkbox>路段</Checkbox>
          </li>
          <li>
            <Checkbox>路口</Checkbox>
          </li>
          <li>
            <Checkbox>地铁</Checkbox>
          </li>
        </ul>
      </div>
