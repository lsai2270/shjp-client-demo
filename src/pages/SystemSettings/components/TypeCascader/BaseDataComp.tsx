    ...
    try {
      ...
      if (res.code == 200) {
        if (res1.code == 200) {
          ...
          // console.log("dicDataTree",dicDataTree);
          let newDicTypeLists = res.data.data
            .filter((item: any) => item._id == '6066c331e7af6700359cef97')
          ...
          // console.log("newDicTypeLists",newDicTypeLists);
          setOptions(newDicTypeLists[0].children);
        }
      }
    } catch (e) {
      message.error('接口报错');
