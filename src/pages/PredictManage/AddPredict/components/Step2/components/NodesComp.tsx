...
const NodesComp: React.ForwardRefRenderFunction<any, any> = (props, ref) => {
  ...
  const { nodesData, linksData, setNodesData, zonesData, currentProject, tabsKey, onmessageE } =
    props;
  ...
  useEffect(() => {
    ...
    // if (nodesData[0] && nodesData[0].isConnector) {
    //   setGateValue('1');
    //   if (nodesData[0]?.values) {
    //     form.setFieldsValue(nodesData[0].values);
    //   } else {
    //     form.setFieldsValue({
    //       zone: { label: nodesData[0].zoneName, value: nodesData[0].zoneId },
    //     });
    //   }
    // } else {
    //   setGateValue('0');
  ...
  useEffect(() => {
    // handleOnWindowMessage();
  }, [tabsKey, nodesData, currentRowIndex, dictData]);
              ...
              >
                ...
                <Select
                  ...
                  onChange={(value: string) => {
                    // console.log(value);0
                    setGateValue(value);
                    if (nodesData[currentRowIndex].crossFlag) {
